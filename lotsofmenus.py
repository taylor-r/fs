...
<html lang="en" class=" is-copy-enabled">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <link rel="web-socket" href="wss://live.github.com/_sockets/MTA3NTMyMzk6NDEzNGNmNjQ4NWJiMjczYzg2NWJkMDEzMWE5Mjg4OWM6ZTQ2Zjc3NDhhOTM4ZWExNDVhMGVjMWNmYzM5MTFjN2I1MmU0ZGZhZDliMGYzMmFjY2Y5NjVhZDA3ZDlhODVhYw==--5d3985b579dd1d6c38de2124bca8900efed36f81">
...
<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="AC55776A:19DF:3E095AF:56515F8E" name="octolytics-dimension-request_id" /><meta content="10753239" name="octolytics-actor-id" /><meta content="taylor-r" name="octolytics-actor-login" /><meta content="5f64804a6b375ca642eb13141bdf08f3ccc2a53004afb13ede5aefc0b33f9a61" name="octolytics-actor-hash" />
...
<meta content="Rails, view, blob#show" data-pjax-transient="true" name="analytics-event" />
  ...
  <meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="user-login" content="taylor-r">

      <link rel="mask-icon" href="https://assets-cdn.github.com/pinned-octocat.svg" color="#4078c0">
      <link rel="icon" type="image/x-icon" href="https://assets-cdn.github.com/favicon.ico">

    <meta content="290c938a1aa821ff50cf43bd58602effad2b343f" name="form-nonce" />
...
<ul class="header-nav user-nav right" id="user-links">
  <li class="header-nav-item">
      <span class="js-socket-channel js-updatable-content"
        data-channel="notification-changed:taylor-r"
...
<a class="dropdown-item" href="/new" data-ga-click="Header, create new repository">
  ...
  <li class="header-nav-item dropdown js-menu-container">
    <a class="header-nav-link name tooltipped tooltipped-s js-menu-target" href="/taylor-r"
       aria-label="View profile and more"
       data-ga-click="Header, show menu, icon:avatar">
      <img alt="@taylor-r" class="avatar" height="20" src="https://avatars0.githubusercontent.com/u/10753239?v=3&amp;s=40" width="20" />
      <span class="dropdown-caret"></span>
    </a>
    ...
    <div class="dropdown-menu-content js-menu-content">
      <div class="dropdown-menu  dropdown-menu-sw">
        <div class=" dropdown-header header-nav-current-user css-truncate">
            Signed in as <strong class="css-truncate-target">taylor-r</strong>
        ...
        <div class="dropdown-divider"></div>
          ...
          <a class="dropdown-item" href="/taylor-r" data-ga-click="Header, go to profile, text:your profile">
            Your profile
          </a>
        ...
        <a class="dropdown-item" href="https://help.github.com" data-ga-click="Header, go to help, text:help">
          ...
          <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/logout" class="logout-form" data-form-nonce="290c938a1aa821ff50cf43bd58602effad2b343f" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="/R1xzVHMo1u4NH5VfAv40Xe29zewjUwartobw/US6PxN1SMw33YaUexxoNiKrUu7TTpgIUD2c1IzHjXtPRYgbg==" /></div>
...
<ul class="pagehead-actions">
  ...
  <li>
        <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-form-nonce="290c938a1aa821ff50cf43bd58602effad2b343f" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="Zr4/A3II0+hkFHCvN/fP8buesvd5CBq3QSXztpBfep6ZD5I1mmoN8Lm6od3SnkkMK52RUBn9qJbDdK0VM7K2pA==" /></div>      <input id="repository_id" name="repository_id" type="hidden" value="30271096" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    ...
    <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/lobrown/Full-Stack-Foundations/unstar" class="js-toggler-form starred js-unstar-button" data-form-nonce="290c938a1aa821ff50cf43bd58602effad2b343f" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="wGjcDkTuQZY/lQIZn+vKLzhZst3VEhofTiThT2ht+Av6IDBbwvlxe2k1mwv2Kh8NuECZBZqYorH0frNti/kb4A==" /></div>
      <button
    ...
    <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/lobrown/Full-Stack-Foundations/star" class="js-toggler-form unstarred js-star-button" data-form-nonce="290c938a1aa821ff50cf43bd58602effad2b343f" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="YP73iVGwVOTW5iOD7cZXpE9P2lq6tN+XupSOVckkTBOeMhurTBGFxrKG+93zp+7OTxf/cJftmw74+tqIyGbbFg==" /></div>
      <button
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/lobrown/Full-Stack-Foundations/fork" class="btn-with-count" data-form-nonce="290c938a1aa821ff50cf43bd58602effad2b343f" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="aUUT+R6ikFtrspvU5gfmQr4yGG2LdxfbHEKsY+5ucZ5Qiej2tvZVlHU5G4rzzRqXTbYOoFTWeJc26VU3BxzhCQ==" /></div>
            <button
                type="submit"
...
<div class="clone-options text-small text-muted">You can clone with
  <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/users/set_protocol?protocol_selector=http&amp;protocol_type=clone" class="inline-form js-clone-selector-form is-enabled" data-form-nonce="290c938a1aa821ff50cf43bd58602effad2b343f" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="rZUGxLVuxfLIgOQiC1GJGXmoZkmQWXl2myzwyJMqeCx7Mt+vIY0ZvwqYGR1xazXHP3Y6hj4p0oD8qDUjPUoAag==" /></div><button class="btn-link js-clone-selector" data-protocol="http" type="submit">HTTPS</button></form>, <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/users/set_protocol?protocol_selector=ssh&amp;protocol_type=clone" class="inline-form js-clone-selector-form is-enabled" data-form-nonce="290c938a1aa821ff50cf43bd58602effad2b343f" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="K14O9MYwBpKDC/cD9maxEYAa2vUwhs7aihMR+aCzplJP8yec9y2xXqQXbAGX0aploHBtjZ1ST5ebVePQhKNJ1A==" /></div><button class="btn-link js-clone-selector" data-protocol="ssh" type="submit">SSH</button></form>, or <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/users/set_protocol?protocol_selector=subversion&amp;protocol_type=clone" class="inline-form js-clone-selector-form is-enabled" data-form-nonce="290c938a1aa821ff50cf43bd58602effad2b343f" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="JyLSglhl9VDEuuA4ZWn2697lJOWhTxhZf5WdsZDo0EmN4g9IHarbljey1tvSEcmuizHTushuYy/kj5ebxETQFA==" /></div><button class="btn-link js-clone-selector" data-protocol="subversion" type="submit">Subversion</button></form>.
  ...
  <div class="file-actions">
    ...
    <div class="btn-group">
      ...
      <a href="/lobrown/Full-Stack-Foundations/commits/master/Lesson_1/lotsofmenus.py" class="btn btn-sm " rel="nofollow">History</a>
        ...
        <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/lobrown/Full-Stack-Foundations/edit/master/Lesson_1/lotsofmenus.py" class="inline-form js-update-url-with-hash" data-form-nonce="290c938a1aa821ff50cf43bd58602effad2b343f" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="sQ9gNRe5TYvemolXD3Qj9WiRKIZnktNDPPkhJyseTL8+2Ui/P8VW20MSZ2gVT10AzVe2jdQW6gObmQtuy0lYSw==" /></div>
          <button class="octicon-btn tooltipped tooltipped-nw" type="submit"
            aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
            <span class="octicon octicon-pencil"></span>
          </button>
</form>        <!-- </textarea> --><!-- '"` --><form accept-charset="UTF-8" action="/lobrown/Full-Stack-Foundations/delete/master/Lesson_1/lotsofmenus.py" class="inline-form" data-form-nonce="290c938a1aa821ff50cf43bd58602effad2b343f" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="OeKlV1lfwT9u7V0aD6Ygyx0zND9ap9QdbhZiCGNZbUEychxoFLm6dcTcE1sNufRnUBa7lrMZcmqPIdmPHb16qg==" /></div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.08355s from github-fe144-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
